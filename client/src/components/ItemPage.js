            ...
            <div>
                <div className="flex">
                    ...
                    <div className="pl-32">
                        ...
                        <div className="flex">
                            <button className="text-orange-500 bg-orange-200 rounded-lg">Trainers</button>
                            <button className="text-green-500 bg-green-200 rounded-lg"> Woman</button>
                        </div>
                        ...
                        <div className="flex gap-2">
                            <p>1</p>
                            <button className="rounded-lg bg-green-300 text-white font-bold"> Add to cart</button>
                        </div>
                    </div>
                </div>
